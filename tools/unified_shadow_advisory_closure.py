...
FINAL_CLOSURE_SCHEMA = "bitevo.unified_shadow_closure.v7"
...
def _verify_ledger(
    ...
    *,
    ...
    if ledger.get("advisory_node_count") != len(ADVISORY_NODES) or ledger.get("all_advisory_nodes_typed") is not True:
...
def build_unified_shadow_advisory_closure(
    ...
    *,
    ...
    """Seal typed trading-advisory contracts while preserving a one-way fail-closed gate."""
    ...
    body = {
        ...
        "planes": {
            **dict(base_closure.get("planes") or {}),
            "trading_advisory_contracts": "BOUND_5_TYPED_NARROW_ONLY",
        },
        "effect_summary": {
