...
def test_backtester_supports_router_strategy_on_mark_stream(tmp_path: Path) -> None:
    ...
    assert report.router_reversion_signal_count >= 1
    assert report.last_router_selected_strategy_kind == "reversion"
