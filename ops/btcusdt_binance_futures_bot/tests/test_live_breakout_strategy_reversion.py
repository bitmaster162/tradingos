...
def test_live_breakout_runner_supports_reversion_strategy_kind(tmp_path) -> None:
    ...
    with JSONLWriter(tmp_path) as writer:
        ...
        assert runner.model.strategy_kind == "reversion"
        assert runner.status.strategy_kind == "reversion"
