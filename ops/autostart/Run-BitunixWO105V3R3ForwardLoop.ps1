...
& $CoreScript `
    -ForwardFloor "2026-07-14T19:30:00Z" `
    -RestCadenceSeconds $RestCadenceSeconds `
    -PythonPath $PythonPath `
    -LaunchAttemptId $LaunchAttemptId `
    -RuntimeTag "bitunix_wo105_v3r3" `
    -LockRelativePath "configs\BITUNIX_WO105_CAUSAL_SHADOW_PREREG_V3R3_2026-07-14.json" `
    -AssemblerScriptRelativePath "tools\bitunix_wo105_packet_assembler_v5.py" `
    -ShadowTag "bitunix_wo105_shadow_v3r3" `
    -CohortLabel "BITUNIX_WO105_V3R3" `
